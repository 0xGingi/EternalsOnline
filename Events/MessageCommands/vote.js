...
module.exports = {
    ...
    async execute(message) {
        ...
        if (this.info.names.some(name => commandName === name)) {
            ...
            .setColor('#0099ff')
            .setTitle('Vote for FlipMMO!')
            .setURL('https://top.gg/bot/1157454837861056552/vote')
            .setDescription('Click the link above to vote for FlipMMO on top.gg and receive a special top.gg reward box!')
            ...
            .setTimestamp()
            .setFooter({ text: 'Thank you for supporting FlipMMO!'});
