    ...
    async execute(message) {
        ...
        if (commandName === 'list') {
            ...
            switch (subCommand) {
                ...
                .addFields(
                    { name: '@Eternals list fish', value: 'list all fish' },
                    { name: '@Eternals list food', value: 'list all food' },
                    { name: '@Eternals list potions', value: 'list all potions'},
                    { name: '@Eternals list ore', value: 'list all ore' },
                    { name: '@Eternals list bars', value: 'list all smithing bars' },
                    { name: '@Eternals list smithing', value: 'list all smithable items' },
                    { name: '@Eternals list crafting', value: 'list all craftable items' },
                    { name: '@Eternals list logs', value: 'list all logs' },
                    { name: '@Eternals list seeds', value: 'list all seeds' },
                    { name: '@Eternals list crops', value: 'list all crops' },
                    { name: '@Eternals list mobs', value: 'list all monsters' },
                    { name: '@Eternals list weapons', value: 'list all weapons' },
                    { name: '@Eternals list armor', value: 'list all armor' },
                    { name: '@Eternals list magic', value: 'list all magic items' },
                    { name: '@Eternals list dungeons', value: 'list all dungeons' },
                    { name: '@Eternals list raids', value: 'list all raids' },
                    { name: '@Eternals list areas', value: 'list all areas' },
                    { name: '@Eternals list pets', value: 'list all pets' },
                    { name: '@Eternals list courses', value: 'list all agility courses' },
                    { name: '@Eternals list partydungeons', value: 'list all party dungeons' },
                );
