        ...
        if (commandName === 'guild') {
            ...
            switch (subCommand) {
                ...
                default:
                    ...
                    .addFields(
                        { name: '@Eternals guild create <name>', value: 'create a guild' },
                        { name: '@Eternals guild join <name>', value: 'join a guild' },
                        { name: '@Eternals guild leave', value: 'leave your guild' },
                        { name: '@Eternals guild list', value: 'list all guilds' },
                        { name: '@Eternals guild kick <@Player>', value: 'kick a player from your guild' },
                        { name: '@Eternals guild ban <@Player>', value: 'perma ban a player from your guild' },
                        { name: '@Eternals guild unban <@Player>', value: 'unban a player from your guild' },
                        { name: '@Eternals guild banned', value: 'view all players banned from your guild' },
                        { name: '@Eternals guild attack <guild name>', value: 'attack another guild' },
                        { name: '@Eternals guild give <coin amount>', value: 'donate coins to your guild bank' },
                        { name: '@Eternals guild destroy <name>', value: 'destroy your guild' },
                        { name: '@Eternals guild raid <raid name>', value: 'attempt a guild raid' },
                        { name: '@Eternals guild loot <item> <@Player>', value: 'distribute raid loot to player' },
                        { name: '@Eternals guild inv', value: 'view your guild inventory' },
                        { name: '@Eternals guild reward', value: 'claim a reward from your guild' },
                        { name: '@Eternals guild view <guild>', value: 'View a guild' },
                        { name: '@Eternals guild promote <@Player>', value: 'Promote a player to officer' },
                        { name: '@Eternals guild demote <@Player>', value: 'Demote a player from officer' },
                        { name: '@Eternals guild leaderboard', value: 'view the guild donation leaderboard' },
                    );
