...
mongoose
   ...
   .then(() => console.log(`Battlegrounds Ready`));
    ...
    async function startBattleground() {    
                try {
                    const channelId = '1200971746908569610';
                    const guildId = '1169374511653728326';
                ...
                .setTimestamp()
                .setFooter({ text: 'FlipMMO Battlegrounds' });
            await channel.send({ embeds: [announcementEmbed2] });
                    ...
                    channel.send({ embeds: [battleground] });
                        //allPlayers.length = 0;
                ...
                channel.send({ embeds: [battleground2] });
                //setTimeout(startBattleground, 30 * 60 * 1000);
                   ...
                   // }, 5 * 1000);
                    ...
                    channel.send('An error occurred while trying to start the battleground.');
                }
            }
            module.exports = startBattleground;
